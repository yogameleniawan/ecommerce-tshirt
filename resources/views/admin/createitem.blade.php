...
<head>
    ...
    <title>Kaos Admin - Create Item</title>
                ...
                <div class="container">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary" style="padding-bottom:20px">Item Kaos</h6>
                            <a class="btn btn-primary" href="/admin/item"> Back</a>
                        </div>

                        <!-- Default form contact -->
                        <form class="text-center border border-light p-5" action="{{ route('item.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <!-- Name -->
                            ...
                            <input type="text" name="color" id="defaultContactFormColor" class="form-control mb-4">

                            <!-- Password -->
                            <label for="defaultContactFormPrice">Price</label>
                            <input type="number" name="price" id="defaultContactFormPrice" class="form-control mb-4">

                            <label for="defaultContactFormQty">Qty</label>
                            <input type="number" name="qty" id="defaultContactFormQty" class="form-control mb-4">
