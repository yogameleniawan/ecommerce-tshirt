...
<head>
    ...
    <title>Kaos Admin - Edit User</title>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="/admin/item">Manage Items (Kaos)</a>
                ...
                <div class="container">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary" style="padding-bottom:20px">Kaos</h6>
                            <a class="btn btn-primary" href="/admin/item"> Back</a>
                        </div>

                        <!-- Default form contact -->
                        <form class="text-center border border-light p-5" action="{{ route('item.update',$data->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <!-- Name -->
                            <label for="defaultContactFormName">Name</label>
                            <input type="text" name="name" id="defaultContactFormName" class="form-control mb-4" value="{{$data->name}}">

                            <!-- Color -->
                            <label for="defaultContactFormColor">Color</label>
                            <input type="text" name="color" id="defaultContactFormColor" class="form-control mb-4" value="{{$data->color}}">

                            <!-- Price -->
                            <label for="defaultContactFormPrice">Price</label>
                            <input type="number" name="price" id="defaultContactFormPrice" class="form-control mb-4" value="{{$data->price}}">
                            <!-- Qty -->
                            <label for="defaultContactFormQty">Qty</label>
                            <input type="number" name="qty" id="defaultContactFormQty" class="form-control mb-4" value="{{$data->qty}}">

                            <!-- File Photo -->
                            <label for="defaultContactFormImage">Image</label>
                            <br>
                            <img src="{{url('storage')}}/{{$data->image}}" style="width:30%">
