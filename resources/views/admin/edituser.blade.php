            ...
            <div id="content">
                ...
                <div class="container">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <form class="text-center border border-light p-5" action="{{ route('admin.update',$data->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <!-- Name -->
                            ...
                            <input type="email" name="email" id="defaultContactFormEmail" class="form-control mb-4" value="{{$data->email}}">
                            ...
                            <select class="browser-default custom-select mb-4" name="roles">
                                ...
                                <option name="current" value="{{$data->roles}}" selected>{{$data->roles}}</option>
                                ...
                                <option name="current" value="{{$data->roles}}" selected>{{$data->roles}}</option>
                                <option name="staff" value="staff">staff</option>
                                <option name="pelanggan" value="pelanggan">pelanggan</option>
                                @endif
                                @if($data->roles == "staff")
                                <option name="current" value="{{$data->roles}}" selected>{{$data->roles}}</option>
                                <option name="admin" value="admin">admin</option>
