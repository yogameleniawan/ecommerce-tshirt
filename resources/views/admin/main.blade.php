...
<head>
    ...
    <title>Kaos Admin - Dashboard</title>
            ...
            <div id="content">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <p></p>
                                <img class="img-profile rounded-circle" src="storage/{{Auth::user()->image_profile}}">
                            </a>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="{{route('export')}}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i> Generate Report</a>
                    </div>
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">Rp. {{$monthly}}</div>
                                        </div>
                                        <div class="col-auto">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Earnings (Annual)</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">Rp. {{$annual}}</div>
                                        </div>
                                        <div class="col-auto">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-4 col-lg-5">
                            <div class="card shadow mb-4">
                                <!-- Card Header - Dropdown -->
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary">Service Score</h6>
                                </div>
                                <!-- Card Body -->
                                <div class="card-body">
                                    ...
                                    <div class="mt-4 text-center small">
                                        <span class="mr-2">
                                            <i class="fas fa-circle" style="color:#CC0000"></i> Angry
                                        </span>
                                        <span class="mr-2">
                                            <i class="fas fa-circle" style="color:#FF8800"></i> Upset
                                        </span>
                                        <span class="mr-2">
                                            <i class="fas fa-circle" style="color:#ffd740"></i> Neutral
                                        </span><br>
                                        <span class="mr-2">
                                            <i class="fas fa-circle" style="color:#00C851"></i> Happy
                                        </span>
                                        <span class="mr-2">
                                            <i class="fas fa-circle" style="color:#007E33"></i> Excited
                                        </span>
                                    </div>
                                </div>
                            </div>
            ...
            var myLineChart = new Chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        pointHitRadius: 10,
                        pointBorderWidth: 2,
                        data: [<?php echo $jan; ?>, <?php echo $feb; ?>, <?php echo $mar; ?>, <?php echo $apr; ?>, <?php echo $mei; ?>, <?php echo $jun; ?>, <?php echo $jul; ?>, <?php echo $aug; ?>, <?php echo $sep; ?>, <?php echo $oct; ?>, <?php echo $nov; ?>, <?php echo $des; ?>],
                    }],
                },
                options: {
        ...
        <script type="text/javascript">
            ...
            var myPieChart = new Chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [{
                        data: [<?= $angry ?>, <?= $upset ?>, <?= $neutral ?>, <?= $happy ?>, <?= $excited ?>],
