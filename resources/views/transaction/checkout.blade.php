...
<body style="background-color: #292929;">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary" style="padding-bottom:20px">Checkout</h6>
            <a class="btn btn-primary" href="/carts">Back</a>
        </div>

        <!-- Default form contact -->
        <form class="text-center border border-light p-5" action="{{ route('cart.update',$data->id) }}" method="POST"
            enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <!-- Name -->
            <label for="name_item">Item Name</label>
            <input type="text" name="name_item" id="name_item" class="form-control mb-4" value="{{$data->name_item}}"
                readonly>

            <label for="name_user">Buyer's Name</label>
            <input type="text" name="name_user" id="name_user" class="form-control mb-4" value="{{$data->name_user}}">

            <label for="address">Address</label>
            <input type="text" name="address" id="address" class="form-control mb-4" value="{{$data->address}}">
            ...
            <p style="color: red;"><b>* Upload your Payment Image to Process your payment</b></p>
            @endif
            @if(!empty($data->payment))
