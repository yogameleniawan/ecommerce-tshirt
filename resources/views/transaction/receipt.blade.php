...
<body style="background-color: #292929;">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary" style="padding-bottom:20px">Receipt</h6>
        ...
        <form class="text-center border border-light p-5">
            ...
            <input type="text" name="receipt" id="defaultContactFormReceipt" class="form-control mb-4" value="No Receipt not available, please wait" readonly>
            @elseif(!empty($receipt->no_receipt))
            <input type="text" name="receipt" id="defaultContactFormReceipt" class="form-control mb-4"
                value="{{$receipt->no_receipt}}" readonly>
            @endif
        </form>
